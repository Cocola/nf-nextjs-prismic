      ...
      <div className="mx-auto w-full max-w-6xl">
        <div className="flex flex-col gap-6 justify-between">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-black text-zinc-800">
            <span className="relative before:transition-transform before:origin-left before:block before:absolute before:-left-2 before:-right-2 before:top-4 before:bottom-4 md:before:bottom-1 before:-z-10 before:bg-primary-light before:scale-x-0 before:scale-y-1 before:animate-underline before:will-change-transform">
              {slice.primary.title}
            </span>
          </h1>
